...
class EditFormWidget extends StatefulWidget {
  ...
  final DocumentReference? postsRef;
...
class _EditFormWidgetState extends State<EditFormWidget>
  ...
  void initState() {
    ...
    _model.itemDetailsFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PostsRecord>(
      stream: PostsRecord.getDocument(widget.postsRef!),
      builder: (context, snapshot) {
        ...
        final editFormPostsRecord = snapshot.data!;
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                          .itemDetailsTextController ??=
                                                      TextEditingController(
                                                    text: editFormPostsRecord
                                                        .itemDetail,
                                                  ),
                                                  focusNode: _model
                                                      .itemDetailsFocusNode,
                                                  autofocus: true,
                                                  textInputAction:
                                                      TextInputAction.next,
                                                  obscureText: false,
                                                  ...
                                                  cursorColor:
                                                      FlutterFlowTheme.of(
                                                          ...
                                                          .primaryText,
                                                  validator: _model
                                                      .itemDetailsTextControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
