  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PostsRecord>>(
      stream: queryPostsRecord(
        queryBuilder: (postsRecord) => postsRecord.orderBy('itemName'),
      ),
      builder: (context, snapshot) {
        ...
        List<PostsRecord> homeCopyPostsRecordList = snapshot.data!;
                        ...
                        child: Column(
                          ...
                          children: [
                                      ...
                                      fieldViewBuilder: (
                                        ...
                                        return TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            filled: true,
                                            fillColor: const Color(0x1F787880),
                            ...
                            if (!_model.searchActive)
                              Builder(
                                builder: (context) {
                                  final reportsNames = homeCopyPostsRecordList
                                      .map((e) => e)
                                      .toList();
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: reportsNames.length,
                                    itemBuilder: (context, reportsNamesIndex) {
                                      final reportsNamesItem =
                                          reportsNames[reportsNamesIndex];
                                      return Container(
                                        height: 294.0,
                                        alignment:
