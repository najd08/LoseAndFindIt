...
import 'report_form_copy_model.dart';
export 'report_form_copy_model.dart';

class ReportFormCopyWidget extends StatefulWidget {
  const ReportFormCopyWidget({super.key});

  @override
  State<ReportFormCopyWidget> createState() => _ReportFormCopyWidgetState();
}

class _ReportFormCopyWidgetState extends State<ReportFormCopyWidget>
    with TickerProviderStateMixin {
  late ReportFormCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportFormCopyModel());
                                          ...
                                          child: Padding(
                                            ...
                                            child: FlutterFlowChoiceChips(
                                              ...
                                              selectedChipStyle: ChipStyle(
                                                ...
                                                iconColor: const Color(0xE51E6F5C),
                                                iconSize: 16.0,
                                                elevation: 0.0,
                                                borderColor: const Color(0xE51E6F5C),
                                                borderWidth: 1.5,
                                                borderRadius:
                                              ...
                                              unselectedChipStyle: ChipStyle(
                                                ...
                                                iconColor: const Color(0xFFC4C4C4),
                                                iconSize: 16.0,
                                                elevation: 0.0,
