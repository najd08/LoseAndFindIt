...
import '/ch/empty_state_simple/empty_state_simple_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> chat2InviteUsersUsersRecordList = snapshot.data!;
                                            ...
                                            child: Theme(
                                              ...
                                              child: CheckboxListTile(
                                                ...
                                                tileColor:
                                                    FlutterFlowTheme.of(context)
                                                        .secondaryBackground,
                                                activeColor: const Color(0xFF2F7050),
