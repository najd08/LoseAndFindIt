...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'intro1',
          path: '/intro1',
          builder: (context, params) => const Intro1Widget(),
        ),
        FFRoute(
          name: 'intro2',
          path: '/intro2',
          builder: (context, params) => const Intro2Widget(),
        ),
        FFRoute(
          name: 'intro3',
          path: '/intro3',
        ...
        FFRoute(
          name: 'chatfeed',
          path: '/chatfeed',
          builder: (context, params) => const ChatfeedWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'HomeYourPosts',
          path: '/homeYourPosts',
          builder: (context, params) => const HomeYourPostsWidget(),
        ),
        FFRoute(
          name: 'HomeCopy',
          path: '/homeCopy',
        ...
        FFRoute(
          name: 'ForTestDB',
          path: '/forTestDB',
          builder: (context, params) => const ForTestDBWidget(),
        ),
        FFRoute(
          name: 'chatfeedCopy',
          path: '/chatfeedCopy',
          builder: (context, params) => const ChatfeedCopyWidget(),
        ),
        FFRoute(
          name: 'chatPage',
          path: '/chatPage',
        ...
        FFRoute(
          name: 'HomeYourPostsCopy',
          path: '/homeYourPostsCopy',
          builder: (context, params) => const HomeYourPostsCopyWidget(),
        ),
        FFRoute(
          name: 'EditForm',
          path: '/editForm',
          builder: (context, params) => EditFormWidget(
            postsRef: params.getParam(
              'postsRef',
